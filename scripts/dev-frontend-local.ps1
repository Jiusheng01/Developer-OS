...
$env:NEXT_PUBLIC_DASHBOARD_DATA_PROVIDER = "local"
$env:NEXT_PUBLIC_API_BASE_URL = $ApiBaseUrl

Write-Host "Starting Developer OS frontend in localStorage mode on http://${HostName}:$Port"
Write-Host "Data provider: $env:NEXT_PUBLIC_DASHBOARD_DATA_PROVIDER"
